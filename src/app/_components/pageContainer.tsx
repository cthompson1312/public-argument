...
function PageContainer({ children }: { children: React.ReactNode }) {
  const [theme, setTheme] = useState<boolean>(() => {
    ...
    const storedTheme = window.localStorage.getItem("page-theme");
    return storedTheme ? storedTheme === "black" : true;
  });

  useEffect(() => {
    window.localStorage.setItem("page-theme", theme ? "black" : "retro");
  }, [theme]);
